...
import Config from './config/en/config.js'; //load the config for your language
...
window.CMLRPG = function(){ //creating a new Object of this kind will start the RPG in the command line or whatever avatr you choose
